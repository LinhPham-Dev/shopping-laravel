...
<main class="main">
    <div class="page-content">
                ...
                <div class="row">
                        ...
                        <div class="category category-default1 category-absolute banner-radius overlay-zoom">
                            <a href="shop.html">
                                <figure class="category-media">
                                    <img src="{{asset('asset-frontend')}}/images/categories/category1.jpg"
                                        alt="category" width="280" height="280" style="background-color: #8c8c8d;" />
                                </figure>
                            </a>
                    ...
                    <div class="col-xs-6 col-lg-3 mb-4">
                        <div class="category category-default1 category-absolute banner-radius overlay-zoom">
                            <a href="shop.html">
                                <figure class="category-media">
                                    <img src="{{asset('asset-frontend')}}/images/categories/category2.jpg"
                                        alt="category" width="280" height="280" style="background-color: #bcbdb7;" />
                                </figure>
                            </a>
                            <div class="category-content">
                    ...
                    <div class="col-xs-6 col-lg-3 mb-4">
                        <div class="category category-default1 category-absolute banner-radius overlay-zoom">
                            <a href="shop.html">
                                <figure class="category-media">
                                    <img src="{{asset('asset-frontend')}}/images/categories/category3.jpg"
                                        alt="category" width="280" height="280" style="background-color: #ececef;" />
                                </figure>
                            </a>
                            <div class="category-content">
                    ...
                    <div class="col-xs-6 col-lg-3 mb-4">
                        <div class="category category-default1 category-absolute banner-radius overlay-zoom">
                            <a href="shop.html">
                                <figure class="category-media">
                                    <img src="{{asset('asset-frontend')}}/images/categories/category4.jpg"
                                        alt="category" width="280" height="280" style="background-color: #e8eded;" />
                                </figure>
                            </a>
            ...
            <div class="owl-carousel owl-theme row owl-nav-full cols-2 cols-md-3 cols-lg-4" data-owl-options="{
                ...
                <div class="product text-center">
                    <figure class="product-media">
                        <a href="product.html">
                            <img src="{{asset('asset-frontend')}}/images/demos/demo1/products/product1.jpg"
                ...
                <div class="product text-center">
                    <figure class="product-media">
                        <a href="product.html">
                            <img src="{{asset('asset-frontend')}}/images/demos/demo1/products/product2.jpg"
                                alt="Blue Pinafore Denim Dress" width="280" height="315"
                                style="background-color: #f2f3f5;" />
                        </a>
                        <div class="product-label-group">
                ...
                <div class="product text-center">
                    <figure class="product-media">
                        <a href="product.html">
                            <img src="{{asset('asset-frontend')}}/images/demos/demo1/products/product3.jpg"
                                alt="Blue Pinafore Denim Dress" width="280" height="315"
                                style="background-color: #f2f3f5;" />
                        </a>
                ...
                <div class="product text-center">
                    <figure class="product-media">
                        <a href="product.html">
                            <img src="{{asset('asset-frontend')}}/images/demos/demo1/products/product4.jpg"
                                alt="Blue Pinafore Denim Dress" width="280" height="315"
                                style="background-color: #f2f3f5;" />
                        </a>
                        <div class="product-label-group">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-sm-6 mb-4">
                        <div class="banner banner-3 banner-fixed banner-radius content-middle appear-animate"
                            ...
                            <figure>
                                <img src="{{asset('asset-frontend')}}/images/demos/demo1/banners/banner1.jpg" alt="banner" width="380" height="207"
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4 order-lg-auto order-sm-last">
                        <div class="banner banner-4 banner-fixed banner-radius content-middle content-center appear-animate"
                            ...
                            <figure>
                                <img src="{{asset('asset-frontend')}}/images/demos/demo1/banners/banner2.jpg" alt="banner" width="350" height="177"
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        <div class="banner banner-5 banner-fixed banner-radius content-middle appear-animate"
                            ...
                            <figure>
                                <img src="{{asset('asset-frontend')}}/images/demos/demo1/banners/banner3.jpg" alt="banner" width="380" height="207"
        ...
        <section class="product-wrapper mt-6 mt-md-10 pt-4 mb-10 pb-2 container appear-animate" data-animation-options="{
            ...
            <div class="owl-carousel owl-theme row cols-2 cols-md-3 cols-lg-4 cols-xl-5" data-owl-options="{
                ...
                <div class="product text-center">
                    <figure class="product-media">
                        <a href="product.html">
                            <img src="{{asset('asset-frontend')}}/images/demos/demo1/products/product5.jpg"
                ...
                <div class="product text-center">
                    <figure class="product-media">
                        <a href="product.html">
                            <img src="{{asset('asset-frontend')}}/images/demos/demo1/products/product6.jpg"
                                alt="Blue Pinafore Denim Dress" width="220" height="245"
                                style="background-color: #f2f3f5;" />
                        </a>
                        <div class="product-label-group">
                ...
                <div class="product text-center">
                    <figure class="product-media">
                        <a href="product.html">
                            <img src="{{asset('asset-frontend')}}/images/demos/demo1/products/product7.jpg"
                                alt="Blue Pinafore Denim Dress" width="220" height="245"
                                style="background-color: #f2f3f5;" />
                        </a>
                        <div class="product-action-vertical">
                ...
                <div class="product text-center">
                    <figure class="product-media">
                        <a href="product.html">
                            <img src="{{asset('asset-frontend')}}/images/demos/demo1/products/product8.jpg"
                                alt="Blue Pinafore Denim Dress" width="220" height="245"
                                style="background-color: #f2f3f5;" />
                        </a>
                        <div class="product-label-group">
                ...
                <div class="product text-center">
                    <figure class="product-media">
                        <a href="product.html">
                            <img src="{{asset('asset-frontend')}}/images/demos/demo1/products/product9.jpg"
                                alt="Blue Pinafore Denim Dress" width="220" height="245"
                                style="background-color: #f2f3f5;" />
                        </a>
                        <div class="product-label-group">
        ...
        <section class="banner banner-background parallax text-center" data-option="{'offset': -60}"
            data-image-src="{{asset('asset-frontend')}}/images/demos/demo1/parallax.jpg"
            style="background-color: #2d2f33;">
            <div class="container">
                        ...
                        <div class="widget widget-products appear-animate" data-animation-options="{
                            ...
                            <div class="products-col">
                                <div class="product product-list-sm">
                                    <figure class="product-media">
                                        <a href="product.html">
                                            <img src="{{asset('asset-frontend')}}/images/demos/demo1/products/product10.jpg"
                                ...
                                <div class="product product-list-sm">
                                    <figure class="product-media">
                                        <a href="product.html">
                                            <img src="{{asset('asset-frontend')}}/images/demos/demo1/products/product11.jpg"
                                                alt="product" width="100" height="114"
                                                style="background-color: #f2f3f5;" />
                                        </a>
                                    </figure>
                                ...
                                <div class="product product-list-sm">
                                    <figure class="product-media">
                                        <a href="product.html">
                                            <img src="{{asset('asset-frontend')}}/images/demos/demo1/products/product12.jpg"
                                                alt="product" width="100" height="114"
                                                style="background-color: #f2f3f5;" />
                                        </a>
                                    </figure>
                        ...
                        <div class="widget widget-products appear-animate" data-animation-options="{
                            ...
                            <div class="products-col">
                                <div class="product product-list-sm">
                                    <figure class="product-media">
                                        <a href="product.html">
                                            <img src="{{asset('asset-frontend')}}/images/demos/demo1/products/product13.jpg"
                                                alt="product" width="100" height="114"
                                                style="background-color: #f2f3f5;" />
                                        </a>
                                    </figure>
                                ...
                                <div class="product product-list-sm">
                                    <figure class="product-media">
                                        <a href="product.html">
                                            <img src="{{asset('asset-frontend')}}/images/demos/demo1/products/product14.jpg"
                                                alt="product" width="100" height="114"
                                                style="background-color: #f2f3f5;" />
                                        </a>
                                    </figure>
                                ...
                                <div class="product product-list-sm">
                                    <figure class="product-media">
                                        <a href="product.html">
                                            <img src="{{asset('asset-frontend')}}/images/demos/demo1/products/product15.jpg"
                                                alt="product" width="100" height="114"
                                                style="background-color: #f2f3f5;" />
                                        </a>
                                    </figure>
                        ...
                        <div class="widget widget-products appear-animate" data-animation-options="{
                            ...
                            <div class="products-col">
                                <div class="product product-list-sm">
                                    <figure class="product-media">
                                        <a href="product.html">
                                            <img src="{{asset('asset-frontend')}}/images/demos/demo1/products/product16.jpg"
                                                alt="product" width="100" height="114"
                                                style="background-color: #f2f3f5;" />
                                        </a>
                                    </figure>
                                ...
                                <div class="product product-list-sm">
                                    <figure class="product-media">
                                        <a href="product.html">
                                            <img src="{{asset('asset-frontend')}}/images/demos/demo1/products/product17.jpg"
                                                alt="product" width="100" height="114"
                                                style="background-color: #f2f3f5;" />
                                        </a>
                                    </figure>
                                ...
                                <div class="product product-list-sm">
                                    <figure class="product-media">
                                        <a href="product.html">
                                            <img src="{{asset('asset-frontend')}}/images/demos/demo1/products/product18.jpg"
                                                alt="product" width="100" height="114"
                                                style="background-color: #f2f3f5;" />
                                        </a>
                                    </figure>
                        ...
                        <div class="widget widget-products appear-animate" data-animation-options="{
                            ...
                            <div class="products-col">
                                <div class="product product-list-sm">
                                    <figure class="product-media">
                                        <a href="product.html">
                                            <img src="{{asset('asset-frontend')}}/images/demos/demo1/products/product19.jpg"
                                                alt="product" width="100" height="114"
                                                style="background-color: #f2f3f5;" />
                                        </a>
                                    </figure>
                                ...
                                <div class="product product-list-sm">
                                    <figure class="product-media">
                                        <a href="product.html">
                                            <img src="{{asset('asset-frontend')}}/images/demos/demo1/products/product20.jpg"
                                                alt="product" width="100" height="114"
                                                style="background-color: #f2f3f5;" />
                                        </a>
                                    </figure>
                                ...
                                <div class="product product-list-sm">
                                    <figure class="product-media">
                                        <a href="product.html">
                                            <img src="{{asset('asset-frontend')}}/images/demos/demo1/products/product21.jpg"
                                                alt="product" width="100" height="114"
                                                style="background-color: #f2f3f5;" />
                                        </a>
                                    </figure>
